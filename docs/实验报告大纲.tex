...
% ==================== 下划线填空命令 ====================
\newcommand{\ulinefill}[2][200pt]{\underline{\makebox[#1][c]{#2}}}
...
\begin{titlepage}
    ...
    % Logo 图片（如果有的话）
    % \includegraphics[width=0.6\textwidth]{zju_logo.png}
    ...
    \begin{tabular}{r c}
        \textbf{课程名称：} & \ulinefill[250pt]{B/S体系软件设计} \\
        \textbf{姓\hspace{2em}名：} & \ulinefill[250pt]{[学生姓名]} \\
        \textbf{学\hspace{2em}院：} & \ulinefill[250pt]{计算机科学与技术学院} \\
        \textbf{系：} & \ulinefill[250pt]{计算机系} \\
        \textbf{专\hspace{2em}业：} & \ulinefill[250pt]{计算机科学与技术} \\
        \textbf{学\hspace{2em}号：} & \ulinefill[250pt]{[学号]} \\
        \textbf{指导教师：} & \ulinefill[250pt]{胡晓军} \\
    \end{tabular}
    }
...
\begin{table}[h]
    ...
    \begin{tabular}{|p{2.5cm}|p{4.5cm}|p{2.5cm}|p{4.5cm}|}
        \hline
        \textbf{课程名称} & B/S体系软件设计 & \textbf{实验类型} & 综合性 \\ 
        \hline
        \textbf{实验项目名称} & \multicolumn{3}{l|}{智能云图库系统 (Smart Image Gallery)} \\
        \hline
        \textbf{学生姓名} & [学生姓名] & \textbf{同组学生姓名} & 无 \\
        \hline
        \textbf{专业} & 计算机科学与技术 & \textbf{学号} & [学号] \\
        \hline
        \textbf{指导老师} & 胡晓军 & \textbf{实验地点} & 曹光彪西楼 \\
        \hline
        \textbf{实验日期} & 2026年1月5日 & & \\
        \hline
    \end{tabular}
\end{table}
